    ...
    private void enviarNotificacionesConfirmacion(Cita cita) {
        try {
            ...
            if (cita.getIdModalidad() == 2) {
                String linkMeet = "https://meet.google.com/abc-defg-hij"; // Link generado o estático
